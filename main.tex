...
%\subsection{GLE}
\addcontentsline{toc}{subsection}{\cite{GLE}~:~Vers plus de fiabilité sur les résultats de recherche en génie logiciel}
\label{GLE}
\includepdf[pages=-,pagecommand={\thispagestyle{plain}}]{Defis/Vers_plus_de_fiabilite_Res_recherche.pdf}

%\subsection{reconfiguration}
\addcontentsline{toc}{subsection}{\cite{reconfiguration}~:~Safe and optimal component-based dynamic reconfiguration}
...
%\subsection{IA}
\addcontentsline{toc}{subsection}{\cite{IA}~:~Génie Logiciel et Intelligence Artificielle}
\label{IA}
\includepdf[pages=-,pagecommand={\thispagestyle{plain}}]{Defis/Intelligence_Artificielle.pdf}

%\subsection{argumentation}
\addcontentsline{toc}{subsection}{\cite{argumentation}~:~Quelle argumentation pour des systèmes de confiance ?}
\label{argumentation}
...
\addcontentsline{toc}{subsection}{\cite{compilation}~:~Défi en compilation et langages: du parallélisme oui, mais du parallélisme efficace et sûr!}
\label{compilation}
...
\addcontentsline{toc}{subsection}{\cite{emergents}~:~Méthodes formelles pour la conception, la programmation et la vérification de systèmes critiques émergents}
\label{emergents}
\includepdf[pages=-,pagecommand={\thispagestyle{plain}}]{Defis/FM_systemes_emergents.pdf}

%\subsection{debuggers}
\addcontentsline{toc}{subsection}{\cite{debuggers}~:~New Generation Debuggers}
\label{debuggers}
\includepdf[pages=-,pagecommand={\thispagestyle{plain}}]{Defis/New_Generation_Debuggers.pdf}


%\subsection{securite}
\addcontentsline{toc}{subsection}{\cite{securite}~:~La sécurité dans le développement logiciel}
\label{securite}
\includepdf[pages=-,pagecommand={\thispagestyle{plain}}]{Defis/securite_dans_le_developpement_logiciel.pdf}

%\subsection{combinatoire}
\addcontentsline{toc}{subsection}{\cite{combinatoire}~:~Combinatoire certifiée}
\label{combinatoire}
\includepdf[pages=-,pagecommand={\thispagestyle{plain}}]{Defis/combinatoire_certifiee.pdf}


%\subsection{Vert}
\addcontentsline{toc}{subsection}{\cite{vert}~:~Vers des Logiciels éco-responsables, Le génie logiciel au défi de la sobriété écologique}
\label{vert}
\includepdf[pages=-,pagecommand={\thispagestyle{plain}}]{Defis/logiciels_verts.pdf}

%\subsection{coevolution}
\addcontentsline{toc}{subsection}{\cite{coevolution}~:~Gestion de la co-évolution des logiciels partiellement générés pendant la phase d'évolution et de maintenance}
\label{coevolution}
...
%\subsection{Monniaux}
\addcontentsline{toc}{subsection}{\cite{Monniaux}~:~Chaîne de compilation formellement certifiée.}
\label{Monniaux}
